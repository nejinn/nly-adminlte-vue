<template>
  <nly-wrapper>
    <nly-navbar expand variants="info">
      <nly-navbar-nav>
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body pad table-responsive">
                  ...
                  <table class="table table-bordered text-center">
                    ...
                    <tr>
                      <td>
                        <nly-button block pressed variants="default"
                          >Default
                        </nly-button>
                      </td>
                      <td>
                        <nly-button block pressed variants="default" size="lg"
                          >Default
                        </nly-button>
                      </td>
                      <td>
                        <nly-button block pressed variants="default" size="sm"
                          >Default
                        </nly-button>
                      </td>
                      <td>
            ...
            <div class="col-md-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a class="btn btn-app"> <i class="fas fa-play"></i> Play </a>
                  <a class="btn btn-app">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive pad">
                  <p>
                    ...
                    Just add your buttons inside
                    <code
                      >&lt;div class="btn-group-vertical"&gt;&lt;/div&gt;</code
                    >
                  </p>
