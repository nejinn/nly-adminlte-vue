...
import { NlyaPopover } from "../../components/popover/plugin/nlya-popover";

// Key which we use to store tooltip object on element
const NLYA_POPOVER = "__NLYA_Popover__";
...
const applyPopover = (el, bindings, vnode) => {
  ...
  if (!el[NLYA_POPOVER]) {
    ...
    el[NLYA_POPOVER].$on("show", () => /* istanbul ignore next: for now */ {
  ...
  const oldData = el[NLYA_POPOVER].__nlya_prev_data__;
