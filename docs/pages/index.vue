<template>
  <main id="content" role="main">
      ...
      <nly-container tag="article">
        <nly-row align-v="center" no-gutters class="mb-2 mb-md-3 mb-lg-4">
          ...
          <nly-col tag="header" cols="12" md="8" order-md="1">
            ...
            <p class="lead">
              With <span class="font-weight-bolder">BootstrapVue</span> you can
              build responsive, mobile-first, and ARIA accessible projects on
              the web using
              <span class="text-muted font-weight-bolder">Vue.js</span> and the
              world's most popular front-end CSS library &mdash;
              <span class="text-muted font-weight-bolder">Bootstrap v4</span>.
            </p>

            <nly-media no-body class="my-3">
              <nly-media-aside vertical-align="center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 612 612"
                  width="30px"
              ...
              <nly-media-body class="ml-3 text-muted align-self-center">
                <!-- <a :href="bootstrapUrl" target="_blank">Bootstrap v4</a> is the
                world's most popular framework for building responsive,
                mobile-first sites. -->
              </nly-media-body>
            </nly-media>

            <nly-media no-body class="mb-4">
              <nly-media-aside vertical-align="center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <nly-media-body class="ml-3 text-muted align-self-center">
                ...
                (pronounced <span class="text-nowrap">/<i>vjuː</i>/</span>, like
            ...
            <nly-row class="mb-4">
              <nly-col lg="10" offset-lg="1">
                <p class="text-lg-center">
                  With more than 85 components, over 45 available plugins,
                  several directives, and 500+ icons,
                  <span class="bd-text-purple-bright">BootstrapVue</span>
                  provides one of the most comprehensive implementations of the
                  <span class="bd-text-purple-bright">Bootstrap v</span>
                  component and grid system available for
                  <span class="bd-text-purple-bright"
                    >Vue.js v{{ vueVersionMinor }}</span
    ...
    <section class="bv-section bv-white">
      <nly-container>
        <h2 class="h4 text-center text-muted">
          Reasons to choose BootstrapVue
        </h2>
        <nly-card-group deck class="mb-sm-4">
          <nly-card
            tag="article"
          ...
          >
            <nly-card-text
              text-tag="h3"
              class="h5 text-center mb-2 bd-text-purple-bright"
            >
              <nly-icon
                icon="phone"
                width="2.5em"
            ...
            <nly-card-text class="text-center">
              Mobile first
              <nly-link to="/docs/components/layout">responsive</nly-link>
              layout
            </nly-card-text>
          </nly-card>
          ...
          >
            <nly-card-text
              text-tag="h3"
              class="h5 text-center bd-text-purple-bright mb-2"
            >
              <nly-icon
                icon="puzzle"
                width="2.5em"
            ...
            <nly-card-text class="text-center">
              <nly-link to="/docs/#tree-shaking-with-module-bundlers"
                >Import</nly-link
              >
          ...
          >
            ...
            <nly-card-text class="text-center">
              Automated
              <nly-link to="/docs/reference/accessibility"
                >WAI-ARIA accessibility</nly-link
              >
              markup
            </nly-card-text>
          </nly-card>
        ...
        <nly-card-group deck class="mb-n3">
          <nly-card
            tag="article"
            body-text-variant="muted"
            class="rounded-0 border-0"
          >
            ...
            <nly-card-text class="text-center" bg-variant="light">
              Built with
              <a href="https://vuejs.org/">Vue.js v{{ vueVersionMinor }}</a> and
              <a href="https://getbootstrap.com">Bootstrap SCSS v</a>
            </nly-card-text>
          </nly-card>
          ...
          >
            ...
            <nly-card-text class="text-center">
              Create
              <nly-link to="/docs/reference/theming">themes</nly-link> with SCSS
              variables and
              <nly-link to="/docs/misc/settings">global options</nly-link>
            </nly-card-text>
          </nly-card>
    ...
    <section class="bv-section bv-gray">
      <nly-container tag="article" class="text-center">
        ...
        <nly-row class="mb-3">
          <nly-col lg="10" offset-lg="1">
            <p class="text-lg-center mb-0">
              Easily integrate BootstrapVue into your Nuxt.js projects using our
              included Nuxt.js module. You can optionally specify only the
              components, directives and/or plugins you require.
            </p>
          </nly-col>
        </nly-row>
        ...
        <p class="mb-0 text-center">
          ...
          <span class="bd-text-purple-bright">BootstrapVue</span> and generated
          with <a href="https://nuxtjs.org" target="_blank">Nuxt.js</a>
        </p>
      </nly-container>
    </section>
