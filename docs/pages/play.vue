      ...
      <nly-col md="auto" class="mt-2 mt-md-0">
        ...
        >
          ...
          <input
            ...
            name="resources"
            :value="
              [...exportData.externalCss, exportData.externalJs].join(',')
            "
          />
              ...
              <nly-card-header>
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="mb-0">
                    ...
                    <small v-if="compiling" class="text-muted">
                      compiling</small
                    >
                  </h5>
                  <nly-button
            ...
            <nly-card class="play-result" tag="header">
              <nly-card-header>
                <div class="d-flex justify-content-between align-items-center">
                  <h5 class="mb-0">
                    <span>Result</span>
                    <small v-if="compiling || building" class="text-muted">
                      building</small
                    >
                  </h5>
                  <nly-button
...
export default {
  ...
  computed: {
    ...
    isDefault() {
      ...
      return (
        this.js.trim() === DEFAULT_JS.trim() &&
        this.html.trim() === DEFAULT_HTML.trim()
      );
    },
    isBusy() {
  ...
  methods: {
    ...
    loadFromStorage() {
      ...
      const timestamp =
        parseInt(storage.getItem(STORAGE_KEYS.timestamp), 10) || 0;
